...
fun WeatherDetial(data: WeatherModel) {
    ...
    Column(
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            Text(text = "Місцевий час: ", fontWeight = FontWeight.SemiBold, color = Color.White)
            Text(
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                    ...
                    WeatherCardDetail(key = "Вологість", value = "${data.current.humidity}%")
                    WeatherCardDetail(key = "Порив вітру", value = "$windSpeed км/г")
                ...
                Row(
                    ...
                    WeatherCardDetail(key = "Відчуття, ніби", value = "${feelsLike} °C")
                    WeatherCardDetail(key = "Видимість", value = "${visibility} км")
                ...
                Row(
                    ...
                    WeatherCardDetail(key = "УФ-індекс", value = "$uvIndex")
                    WeatherCardDetail(
                        key = " Опади", value = "${precipitation} мм"
                    )
        ...
        Row(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(text = "Пориви", fontWeight = FontWeight.SemiBold, color = Color.White)
                    Spacer(modifier = Modifier.height(20.dp))
                    Text(
                        text = "$gusts км/г",
                        fontSize = 15.sp,
            ...
            Card(
                ...
                Column(
                    ...
                    Text(text = "Індекс тепла", fontWeight = FontWeight.SemiBold, color = Color.White)
                    Spacer(modifier = Modifier.height(20.dp))
                    Text(
                        text = " $heatIndex °C",
                        fontSize = 15.sp,
        ...
        Row(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(text = "Тиск", fontWeight = FontWeight.SemiBold, color = Color.White)
                    Spacer(modifier = Modifier.height(20.dp))
                    Text(
                        text = " $pressure гПа",
                        fontSize = 15.sp,
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            Text(text = "Останнє оновлення:  ", fontWeight = FontWeight.SemiBold, color = Color.White)
            Text(
        ...
        Column(
            ...
            Text(
                text = "Виконав студент ПД-32",
                fontWeight = FontWeight.SemiBold,
                color = Color.White
            )
            Text(
                text = "Євсєєв Тимофій", fontSize = 15.sp,
                fontWeight = FontWeight.Bold
            )
